...
import { Check, Copy, Eye, EyeOff, Key, Loader2, Plus, RefreshCw, Trash2 } from "lucide-react"
    ...
    <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex">
                      ...
                      <Button type="button" variant="outline" size="icon" className="ml-2" onClick={handleCopyToken}>
                  ...
                  <Alert variant="warning">
                    ...
                    <AlertDescription>This token will not be shown again. Please store it securely.</AlertDescription>
                  </Alert>
                </div>
              ) : (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Learn how to use the Creavibe.pro API to integrate with your applications</CardDescription>
        </CardHeader>
