      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card className="shadow-lg">
          <CardContent className="p-8">
            ...
            <p className="text-lg">
              At CreaVibe, our mission is to democratize content creation through AI-powered tools that empower
        ...
        <Card className="shadow-lg">
          <CardContent className="p-8">
            ...
            <p className="text-lg">
              ...
              collaborate in real-time to create content that captivates audiences. CreaVibe aims to be the catalyst
