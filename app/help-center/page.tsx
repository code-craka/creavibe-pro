...
export const metadata: Metadata = {
  title: "Help Center | Creavibe.pro",
  description:
    "Find answers to your questions about Creavibe.pro's AI-powered content creation and collaboration platform.",
}
    ...
    <div className="container mx-auto px-4 py-12 max-w-7xl">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Find answers to your questions about using Creavibe.pro's AI-powered content creation and collaboration
          platform.
        </p>
      </div>
